...
#ifndef SRC_GENETIC_TRAINER_TRAINER_H_
#define SRC_GENETIC_TRAINER_TRAINER_H_
...
class InstumentTrainerC {
 ...
 public:
  ...
  double MeanAbsoluteError(const std::vector<int16_t>& tgt_audio, const double corr_factors);
...
#endif  // SRC_GENETIC_TRAINER_TRAINER_H_
